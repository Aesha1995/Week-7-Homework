...
public class Programme3_MarkSheet {
    ...
    public static void marks(int id,String name) //instance method created
    {
        ...
        if(math<0 || math>=100) //condition for maths marks checking
            {
        ...
        if(sci<0 || sci>=100) //condition for science marks checking
            {
                System.out.println("Invalid Input Marks should be between 0 to 100"); //print if condition is false
        ...
        if(eng<0 || eng>=100) //condition for english marks checking
        {
            System.out.println("Invalid Input Marks should be between 0 to 100"); //print if condition is false
